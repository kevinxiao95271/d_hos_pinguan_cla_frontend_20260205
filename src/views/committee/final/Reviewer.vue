<template>
  <div class="reviewer-assignment-page">
      ...
      <el-card class="left-panel" shadow="hover">
        <template #header>
          <div class="panel-header">
            <span style="font-weight: 600;">📋 入围报名列表</span>
    ...
    <!-- 自动分配对话框 -->
    <el-dialog v-model="autoAssignDialogVisible" title="自动分配决赛评委" width="500px">
...
const loadRegistrations = async () => {
  ...
  try {
    ...
    if (res.success) {
      ...
      console.log(`✅ 加载入围报名列表成功：${registrations.value.length} 条`)
    } else {
