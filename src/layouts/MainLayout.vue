    ...
    const menu = [
      ...
      // 一级：书审阶段
      {
        ...
        children: [
          ...
          { path: '/committee/book-stage/score', title: '书审专家打分' },
      ...
      // 一级：面谈阶段
      {
        ...
        children: [
          ...
          { path: '/committee/interview-stage/score', title: '面谈专家打分' },
          { path: '/committee/interview-stage/interview-only-ranking', title: '面谈标化得分' }
        ]
      },
      // 一级：入围管理（无子项）
